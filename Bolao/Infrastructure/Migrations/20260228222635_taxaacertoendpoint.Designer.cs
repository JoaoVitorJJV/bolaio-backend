...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260228222635_taxaacertoendpoint")]
    partial class taxaacertoendpoint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Transacao", b =>
                {
                    ...
                    b.HasIndex("BolaoId")
                        .HasDatabaseName("ix_transacoes_bolao_id");
            ...
            modelBuilder.Entity("Domain.Entities.Transacao", b =>
                {
                    b.HasOne("Domain.Entities.Bolao", "Bolao")
                        .WithMany()
                        .HasForeignKey("BolaoId")
                        .HasConstraintName("fk_transacoes_boloes_bolao_id");
